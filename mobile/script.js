...
[CRV, $0.05, Coca-Cola Can]`
    ...
    try {
        const res = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-3.0-flash:generateContent?key=${API_KEY}`, {
            method: 'POST',
            mode: 'cors',
            credentials: 'omit',
...
function askHowToRecycle(itemName, type) {
    ...
    fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-3.0-flash:generateContent?key=${API_KEY}`, {
        method: 'POST', headers: {
